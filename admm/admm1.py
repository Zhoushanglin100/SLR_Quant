...
def z_u_update(args, model, device, epoch, batch_idx, name_list=None):
    ...
    if args.optimization == 'savlr':
        if epoch != 1 and batch_idx == 0:
            ...
            satisfied = Lagrangian1(model, name_list) #check if surrogate optimality condition is satisfied.
    ...
    ###############################################################################################
            ...
            satisfied = Lagrangian2(model, name_list) #check if surrogate optimality condition is satisfied.
