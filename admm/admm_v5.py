...
def z_u_update(args, model, device, epoch, iteration, batch_idx, name_list=None):
    ...
    if args.optimization == 'admm':
        ...
        # if (epoch != 1) and ((epoch - 1) % args.admm_epochs == 0) and (batch_idx%args.update_btch == 0):
            # print("Updating Z, U!!!!!!")
...
def admm_adjust_learning_rate(args, optimizer, epoch):
    ...
    When epoch is dividable by args.admm_epochs, the learning rate is reset
