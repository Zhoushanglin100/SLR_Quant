...
#from models.lenet_org import Net
from models.lenet import Net as Net2
# from models20.lenet_org import Net
    ...
    if args.admm_quant:
        ...
        if args.optimization == 'admm':
            for epoch in range(1, args.epochs + 1):
                ...
                admm_train(args, model, device, train_loader, optimizer, epoch, iteration, name_list)
        ...
        if args.optimization == 'savlr':
            epoch = 0
            while iteration[0] < 2*(args.epochs-1):
                epoch += 1
...
# use admm
def admm_train(args, model, device, train_loader, optimizer, epoch, iteration, name_list=None):
    model.train()
